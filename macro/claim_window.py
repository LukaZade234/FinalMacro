...
def is_final_roll_session_before_claim_reset(
    ...
    *,
    ...
    claim_reset 180, rolls_reset 60 → False (two more roll hours before claim resets).
    """
    if next_claim_reset_minutes is None or rolls_reset_minutes is None:
        return False
    return next_claim_reset_minutes <= rolls_reset_minutes + margin_minutes
