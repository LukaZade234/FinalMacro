...
12. ~~**`$oh` histogram → DP**~~ — built, and it confirms the shipped heuristic rather than beating it; see **Solvers** below. **Auto investor** / **app-only wishlist** — new modules, known shape.
